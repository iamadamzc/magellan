...
class MagellanMonitor:
    ...
    def _build_dashboard(self) -> Layout:
        ...
        layout["left"].split_column(
            Layout(Panel(health_table, title="[bold cyan]Account Health[/bold cyan]", border_style="cyan"), name="health"),
            Layout(Panel(positions_table, title="[bold magenta]Active Positions[/bold magenta]", border_style="magenta"), name="positions")
        )
        
        # Right side: Heartbeat + Trade History
        layout["right"].split_column(
            Layout(heartbeat_panel, size=4, name="heartbeat"),
