#!/usr/bin/env python3
"""
Magellan Bear Trap Strategy - Universal Runner
...
# Import strategy
from deployable_strategies.bear_trap.strategy import BearTrapStrategy
...
def main():
    ...
    # Initialize strategy
    # Note: BearTrapStrategy handles data client internally
