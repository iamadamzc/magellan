#!/usr/bin/env python3
"""
Magellan Hourly Swing Strategy - Universal Runner
Account: PA3ASNTJV624
Strategy: Hourly Swing (RSI Hysteresis) v1.0
...
from deployable_strategies.hourly_swing import strategy
...
def get_credentials():
    ...
    if env == "production":
        ...
        account_id = os.getenv("ALPACA_ACCOUNT_ID", "PA3ASNTJV624")
