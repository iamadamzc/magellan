"""
BATCH TEST: Strategy 1 (Daily Trend) - MAG7 Equities
Testing AAPL, MSFT, NVDA, META, AMZN, GOOGL
"""
...
# Fix project root path - go up from strategies -> operations -> docs -> Magellan
...
# Configuration
SYMBOLS = ['AAPL', 'MSFT', 'NVDA', 'META', 'AMZN', 'GOOGL']
RSI_PERIOD = 28
ENTRY_THRESHOLD = 55
EXIT_THRESHOLD = 45
...
# Main execution
print("=" * 80)
print("BATCH TEST: Strategy 1 (Daily Trend) - MAG7 Equities")
print("=" * 80)
...
summary_df.to_csv(output_dir / 'strategy1_mag7_summary.csv', index=False)

print(f"\n\n{'=' * 80}")
print("SUMMARY - Strategy 1 (Daily Trend) - MAG7")
print(f"{'=' * 80}\n")
print(summary_df.to_string(index=False))
print(f"\n✓ Results saved to: {output_dir / 'strategy1_mag7_summary.csv'}")
