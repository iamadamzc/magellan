"""
ORB V10D - Tighter Stop Loss
-----------------------------
V10C problem: Stop at OR_low - 0.75 ATR = -2% to -3.5% losses
But scales at 0.25R/0.5R = only +0.3% to +0.5% wins

FIX: Stop at OR_low (no ATR buffer) = tighter risk, better R:R
"""
...
def run_orb_v10d(symbol, start, end):
    """ORB V10D - Tighter stop at OR low"""
    ...
    params = {
        ...
        'TARGET_13R': 1.3,
        'TRAIL_ATR': 0.4,        # Tighter trail
        'HARD_STOP_BUFFER': 0.0,  # NO buffer, stop at OR low
    }
    ...
    for i in range(len(df)):
        ...
        if position is None:
            ...
            if breakout and volume_ok and price_ok:
                ...
                stop_loss = current_or_low  # TIGHTER: No ATR buffer
