...
configs = {
    "META": {"symbol": "META", "position_limit": 0.10, "notes": "Tier 1 - Top Performer (Sharpe 1.67 in Bear)"},
    "NVDA": {"symbol": "NVDA", "position_limit": 0.10, "notes": "Tier 1 - Strong Momentum (Sharpe 1.19 in Bear)"},
    "AMZN": {"symbol": "AMZN", "position_limit": 0.10, "notes": "Tier 1 - Consistent (Sharpe 0.95 in Bear)"},
    "COIN": {
        "symbol": "COIN",
...
strategy_params = {
    ...
    "parameters": {
        "rsi_period": 28,
        "entry_regime_bull": {"rsi_threshold": 55, "spy_ma_period": 200, "sentiment_threshold": -0.2},
        "entry_breakout_strong": {"rsi_threshold": 65, "sentiment_threshold": 0.0},
        "exit_conditions": {"rsi_threshold": 45, "sentiment_threshold": -0.3},
    },
}
