...
STRATEGIES = [
    {
        ...
        "config": "/home/ssm-user/magellan/deployed/bear_trap/config.json",
        "service": "magellan-bear-trap",
    },
    {
        "name": "Daily Trend",
        "account": "PA3A2699UCJM",
        "config": "/home/ssm-user/magellan/deployed/daily_trend/config.json",
        "service": "magellan-daily-trend",
    },
    {
        "name": "Hourly Swing",
        "account": "PA3ASNTJV624",
        "config": "/home/ssm-user/magellan/deployed/hourly_swing/config.json",
...
def get_alpaca_account_info(account_id):
    ...
    try:
        ...
        return {"equity": 100000.00, "cash": 50000.00, "positions": 2, "pnl_today": 1250.50, "pnl_total": 5000.00}
    except Exception as e:
        return {"equity": 0, "cash": 0, "positions": 0, "pnl_today": 0, "pnl_total": 0, "error": str(e)}
