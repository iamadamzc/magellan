...
def run_backtest(strategy_name: str, start_date: str, end_date: str, use_cache: bool = True) -> Dict:
    """
...
def main():
    ...
    parser.add_argument("--use-cache", action="store_true", help="Use cached/archived data instead of live API")

    args = parser.parse_args()

    try:
        results = run_backtest(
            strategy_name=args.strategy, start_date=args.start_date, end_date=args.end_date, use_cache=args.use_cache
        )
