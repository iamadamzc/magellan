...
class AlpacaDataClient:
    ...
    def fetch_historical_bars(
        self, symbol: str, timeframe: str, start: str, end: str, feed: str = "sip", lookback_buffer: int = 0
    ) -> pd.DataFrame:
        """
        ...
        try:
            bars = self.api.get_bars(symbol=symbol, timeframe=tf, start=adjusted_start, end=end, feed=feed).df
...
def force_resample_ohlcv(df: pd.DataFrame, target_interval: str, ticker: str = "UNKNOWN") -> tuple:
    """
    ...
    interval_seconds = {"1Min": 60, "3Min": 180, "5Min": 300, "15Min": 900, "30Min": 1800, "1Hour": 3600, "1Day": 86400}
...
class FMPDataClient:
    ...
    def fetch_historical_bars(
        self, symbol: str, timeframe: str, start: str, end: str, lookback_buffer: int = 0
    ) -> pd.DataFrame:
        """
        ...
        params = {"from": adjusted_start, "to": end, "apikey": self.api_key}
    ...
    def fetch_news_sentiment(self, symbol: str) -> dict:
        ...
        params = {"symbol": symbol, "limit": 250, "apikey": self.api_key}
        ...
        try:
            ...
            if not data or len(data) == 0:
                ...
                return {"symbol": symbol, "sentiment": 0.0, "publishedDate": datetime.utcnow()}
            ...
            return {"symbol": symbol, "sentiment": float(avg_sentiment), "publishedDate": published_date}
    ...
    def fetch_historical_news(
        ...
        params = {"symbols": symbol, "from": start_date, "to": end_date, "apikey": self.api_key}
