...
def calculate_ic(df: pd.DataFrame, feature_col: str, target_col: str = "log_return", horizon: int = 15) -> float:
    """
...
def check_feature_correlation(df: pd.DataFrame, feature_a: str, feature_b: str) -> float:
    """
